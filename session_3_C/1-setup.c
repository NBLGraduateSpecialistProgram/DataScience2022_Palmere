...
int main ()
{
  ...
  disini ();               // Initialize DISLIN with default plot parameters --> __init__(self): pass
...
// C does not have classes. Instead we only call routines to carry out runtime operations.
